...
beforeEach(async () => {
    ...
    campaign = await new web3.eth.Contract(JSON.parse(compiledCampaign.interface), campaignAddress); // Utilitzem aquest codi quan el contracte ja esta deployat i lhem de buscar
});
